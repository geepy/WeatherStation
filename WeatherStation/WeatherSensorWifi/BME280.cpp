	...
	int32_t t_fine)
{
	...
	int32_t   dig_H1 = m_dig[24];
	int32_t dig_H2 = (m_dig[26] << 8) | m_dig[25];
	int32_t   dig_H3 = m_dig[27];
	int32_t dig_H4 = (m_dig[28] << 4) | (0x0F & m_dig[29]);
	int32_t dig_H5 = (m_dig[30] << 4) | ((m_dig[29] >> 4) & 0x0F);
	int32_t   dig_H6 = m_dig[31];

	int32_t v_x1_u32r;
	v_x1_u32r = t_fine - 76800;
	v_x1_u32r = (((((adc_H << 14)-(dig_H4 << 20)-(dig_H5 *v_x1_u32r)) + 16384) >> 15) * (((((((v_x1_u32r *dig_H6) >> 10) * (((v_x1_u32r * dig_H3) >> 11) +32768)) >> 10) + 2097152L) * dig_H2 +8192) >> 14));
